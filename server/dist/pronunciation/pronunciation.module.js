...
const pronunciation_schema_1 = require("./schemas/pronunciation.schema");
const config_1 = require("@nestjs/config");
let PronunciationModule = class PronunciationModule {
};
PronunciationModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'en', schema: pronunciation_schema_1.PronunciationSchema }, { name: 'fr', schema: pronunciation_schema_1.PronunciationSchema }, { name: 'es', schema: pronunciation_schema_1.PronunciationSchema }]),
