...
const FRANCE = <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-fr" viewBox="0 0 640 480">
  <g fillRule="event" strokeWidth="1pt">
...
const USA = <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-us" viewBox="0 0 640 480">
  <g fillRule="event">
    <g strokeWidth="1pt">
      <path fill="#bd3d44"
...
const SPAIN = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 750 500" height="38px">
  ...
  <g stroke="#000">
    <g>
      ...
      <g id="b" fill="none">
        ...
        <path d="M176.8 226.08v-1.16m-.58 1.2l.01-1.23m-.43 1.25v-1.26"/>
        <path d="M175.44 226.15v-1.27"/>
        <path d="M175.09 226.15v-1.27"/>
        <path d="M174.77 226.15v-1.27m-.33 1.27v-1.27"/>
        <path d="M174.16 226.15v-1.27"/>
        <path d="M173.61 226.08l-.01-1.15m.27 1.17v-1.21"/>
        <path d="M173.1 226.03v-1.06m.26 1.09l-.01-1.13"/>
        <path d="M172.42 225.97v-.93m.23.94V225m.23 1.02V225"/>
        <path d="M172.19 225.96v-.9"/>
        <path d="M171.97 225.92v-.85"/>
        <path d="M171.73 225.89v-.78"/>
        <path d="M171.24 225.82l-.01-.62m.26.66v-.7m-.5.61v-.55"/>
        <path d="M170.76 225.73v-.46"/>
        <path d="M170.51 225.67v-.36"/>
        <path d="M170.26 225.64v-.27"/>
        <path d="M169.99 225.58v-.13"/>
      </g>
    </g>
    <g id="c">
      <g fill="#005bbf">
    ...
    <g fill="#c8b100">
      ...
      <ellipse fill="#005bbf" cx="250.05" cy="167.3" rx="4.43" ry="4.2"/>
      <path
    ...
    <g fill="none">
      ...
      <path d="M258.04 224.28v-6.01m-3.02 6.21l.04-6.37m-2.24 6.45v-6.49"/>
      <path d="M250.95 224.64v-6.57"/>
      <path d="M249.16 224.64v-6.57"/>
      <path d="M247.48 224.64v-6.57"/>
      <path d="M245.81 224.64v-6.57"/>
      <path d="M244.32 224.64v-6.57"/>
      <path d="M241.48 224.28l-.04-5.97m1.39 6.05v-6.25"/>
      <path d="M238.86 224.01v-5.5m1.33 5.66l-.04-5.86"/>
      <path d="M235.35 223.7v-4.84m1.15 4.92v-5.08m1.19 5.24v-5.28"/>
      <path d="M234.12 223.66v-4.68"/>
      <path d="M232.97 223.42v-4.36"/>
      <path d="M231.74 223.31v-4.06"/>
      <path d="M229.22 222.95l-.04-3.22m1.33 3.38v-3.62"/>
      <path d="M227.93 222.68v-2.84"/>
      <path d="M226.74 222.45v-2.36"/>
      <path d="M225.45 222.13v-1.85"/>
      <path d="M224.12 221.98v-1.38"/>
      <path d="M222.72 221.66v-.67"/>
    ...
    <g>
      ...
      <path id="e" fill="#c8b100" stroke="#c8b100"
      ...
      <path fill="#058e6e"
            ...
            stroke="none"/>
      <g fill="#c8b100">
        <path fill="#ad1519" d="M200.12 281.25h50.18v-55.72h-50.18v55.72z"/>
        <path
      ...
      <g fill="none">
        ...
        <path d="M282.57 240.9s-.34-.48-.42-.65c-.09-.15-.23-.48-.23-.48"/>
...
const FEMALE = <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
  <path
...
const MALE = <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
  <path
...
export default {ADD, DEL, MICRO, PLAY, GENDER, COUNTRY}
